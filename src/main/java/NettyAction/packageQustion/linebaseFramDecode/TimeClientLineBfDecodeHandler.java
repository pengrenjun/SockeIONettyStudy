...
/**
 * @Description 时间客户端处理器(基于LineBaseFramDecode处理半包的处理改造)
 * @Date 2019/9/18 0018 下午 3:47
 * @Created by Pengrenjun
 */
@ChannelHandler.Sharable
public class TimeClientLineBfDecodeHandler extends ChannelHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        for(int i=0;i<10;i++){
            ...
            //发送指令
            logger.info("channelActive->向服务器端发送指令..{}",i);
