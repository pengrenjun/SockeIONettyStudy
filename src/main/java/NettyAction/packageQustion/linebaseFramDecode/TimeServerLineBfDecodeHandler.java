...
/**
 * @Description 时间服务器处理器(基于LineBaseFramDecode处理半包问题处理器改造)
 * @Date 2019/9/18 0018 上午 11:33
 * @Created by Pengrenjun
 */
@ChannelHandler.Sharable
public class TimeServerLineBfDecodeHandler extends ChannelHandlerAdapter {

    Logger logger= LoggerFactory.getLogger(TimeServerLineBfDecodeHandler.class);
...
//        String body=new String(bytes, CharsetUtil.UTF_8).substring(0,bytes.length-separatorLen);
        ...
        //修改点：msg为String类型;不需要对回车换行符进行额外的处理
